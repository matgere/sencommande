...
class Jcart {
	...
	* @return mixed
	*/
	private function record_item($id, $name, $price, $qty = 1, $url) {
	  require_once("../includes/Database.php");
    $query = "INSERT INTO commandes (membre_id, date_commande, numero_commande, mois_commande, annee_commande)    
              VALUES('$membre', '$datedujour', $numero, $mois, $annee)";
