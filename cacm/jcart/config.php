...
$config['checkoutPath']           = 'commandes.php';
...
$config['text']['cartTitle']      = 'Vos Commandes';    // Shopping Cart
$config['text']['singleItem']     = '';    // Item
$config['text']['multipleItems']  = '';    // Items
$config['text']['subtotal']       = 'Total';    // Subtotal
$config['text']['update']         = '';    // update
$config['text']['checkout']       = 'Continuer';    // checkout
$config['text']['checkoutPaypal'] = 'Confirmer';    // Checkout with PayPal
